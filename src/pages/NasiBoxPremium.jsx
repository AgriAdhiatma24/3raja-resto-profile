...
import { BoxPremium } from "../data";
import { useNavigate } from "react-router-dom";
import MenuCardsNasBoxPremi from "../components/MenuCardsNasBoxPremi";

const NasiBoxPremium = () => {
  ...
  return (
    <div className="menu-page w-100 min-vh-100">
      <Container>
        <Row>
          <Col>
            <h1 className="text-center fw-bold">Nasi Box Ekonomis</h1>
            <p className="text-center">
              Berikut adalah seluruh pilihan menu nasi box ekonomis
            </p>
          </Col>
        </Row>
        <Row>
          {BoxPremium.map((menu) => (
            <MenuCardsNasBoxPremi
              key={menu.id}
              title={menu.title}
              price={menu.price}
              items={menu.items}
            ...
            <ul>
              <li>
                ...
                <ol className="alphabet-list">
                  <li>Pemesanan minimal 100 pax</li>
